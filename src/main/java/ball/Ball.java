...
//            if (collisionInfo != null) {
//                Velocity v = collisionInfo.getCollidable().hit(this, collisionInfo.getClosetPoint(), currentVelocity);
//                this.velocity = v;
//                // Di chuyển gần đến điểm va chạm, rồi nảy
//                this.center = new Point(
//                        collisionInfo.getClosetPoint().getX() + v.getDx() * 0.001,
//                        collisionInfo.getClosetPoint().getY() + v.getDy() * 0.001
//                );
//            } else {
//                this.center = this.velocity.applyToPoint(this.center);
//            }
